                ...
                >
                        ...
                        <div className="grid gap-5 sm:flex sm:justify-center ">
                                <a
                                        ...
                                        className="sm:w-2/3 flex justify-center items-center text-8xl text-text gap-4 p-5 hover:bg-secondary hover:scale-105 transition-all group bg-tertiary"
                                >
                                ...
                                <div className="sm:w-2/3 flex justify-center items-center text-7xl text-text gap-4 p-5 hover:bg-secondary hover:scale-105 transition-all group bg-tertiary">
